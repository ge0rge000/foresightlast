    ...
    <div class="card-content collapse show">
        <div class="card-body">
            <form wire:submit.prevent="submitForm" class="form">
                <div class="form-body">
                    <h4 class="form-section"><i class="ft-user"></i> تعديل متابعة</h4>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="response_id">الاستجابة</label>
                                <select id="response_id" class="form-control" wire:model="response_id">
                                    <option value="" selected >اختر الاستجابة</option>
